...
def find_Handpos(scale_Pickx2,scale_Picky2,dis):
    if dis == 'max':
        return (int(480-(193/scale_Pickx2)),int(270-(100/scale_Picky2)))
    elif dis == "min":
        return (int(480-(193/scale_Pickx2)),int(270+(125/scale_Picky2)))
